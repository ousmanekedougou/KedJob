                ...
                <div class="page-inner py-5">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                        <div>
                            ...
                            <h5 class="text-white op-7 mb-2">Plus de {{ $tags->count() }} offre d'emplois</h5>
                        </div>
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															<button type="button" title="" class="btn btn-link btn-primary btn-lg" data-toggle="modal" data-target="#addRowModalEdit-{{ $tag->id }}">
																<i class="fa fa-edit"></i>
															</button>

															<div class="modal fade" id="addRowModalEdit-{{ $tag->id }}" tabindex="-1" role="dialog" aria-hidden="true">
																<div class="modal-dialog modal-lg" role="document">
																	<div class="modal-content">
																		<div class="modal-header no-bd">
																			<h5 class="modal-title">
																				<span class="fw-mediumbold text-center">
																				Modifier le category de {{$tag->name}}</span>
																			</h5>
																				...
																				<div class="row">
																					<div class="col-sm-6">
																						<div class="form-group form-group-default">
																							...
																							<input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') ?? $tag->name}}" required autocomplete="title" autofocus placeholder="Nom Complet">
																							@error('title')
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <div class="form_box form-group form-group-default">
                                                                                            <label class="">Selectioner votre categorie <span style="color:red;">*</span> </label>
                                                                                            <select id="category" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category') }}" required autocomplete="category" autofocus>
                                                                                                @foreach($categorys as $category)
                                                                                                    ...
                                                                                                    @if($category->id == $tag->category->id) selected @endif    
                                                                                        ...
                                                                                        <div class="form-check">
                                                                                            ...
                                                                                            <label class="form-radio-label">
                                                                                                <input id="status" class="form-radio-input" type="radio" name="status"
                                                                                                    value="1" class="@error('status') is-invalid @enderror" @if($tag->status == 1) checked @endif>
                                                                                                <span class="form-radio-sign">Publier</span>
                                                                                            </label>
                                                                                            <label class="form-radio-label ml-3">
                                                                                                <input id="status" class="form-radio-input" type="radio" name="status"
                                                                                                    value="0" class="@error('status') is-invalid @enderror" @if($tag->status == 0) checked @endif>
															...
															<button type="button"  title="" class="btn btn-link btn-danger" data-original-title="Remove" data-toggle="modal" data-target="#addRowModalDestroy-{{ $tag->id }}">
																<i class="fa fa-times"></i>
															</button>

															<div class="modal fade" id="addRowModalDestroy-{{ $tag->id }}" tabindex="-1" role="dialog" aria-hidden="true">
																<div class="modal-dialog" role="document">
																	<div class="modal-content">
																		<div class="modal-header no-bd">
																			<h5 class="modal-title">
																				<span class="fw-mediumbold text-center">
																				Suppression de  {{$tag->name}}</span>
																			</h5>
																			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																				<span aria-hidden="true">&times;</span>
																			</button>
																		...
																		<form method="POST" action="{{ route('admin.tag.destroy',$tag->id) }}">
																			...
																			<div class="modal-body text-center">
																				<div class="row">
																					<div class="col-md-12 text-center">
																						<p>
																							Etes vous sure de bien voiloire supprimer la categorie {{$tag->name}}
																						</p>
																					</div>
																				</div>
																			</div>
            ...
            <div class="modal-content">
                <div class="modal-header no-bd">
                    <h5 class="modal-title">
                        ...
                        Ajouter une nouvelle ettiquette</span>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <form method="POST" action="{{ route('admin.tag.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                    <label>Titre de l'article <span style="color:red;">*</span> </label>
