				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
					<div class="single_about_thumb mb-3">
						<div class="single_about_thumb_inner">
							<img src="{{asset('user/assets/images/about-img.png')}}" alt="" />
						</div>
					</div>
					<div class="single_about_shape">
						<div class="single_about_shape_thumb bounce-animate">
							<img src="{{asset('user/assets/images/about-circle.png')}}" alt="" />
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
...
le meilleur matériel au monde</p>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="row">
						...
						<div class="testimonial_list owl-carousel curosel-style">
							...
							@foreach($temoignages as $temoign)
								<div class="col-lg-12">
	...
	<!--==================================================-->
	<div class="contact_area pt-85 pb-90" style="background-image:url(user/assets/images/bg-cnt.jpg)">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form_box mb-30">
										<input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name"  placeholder="Votre prenom et nom">
										@error('name')
								...
								<div class="col-lg-6">
									<div class="form_box mb-30">
										<input id="job" type="text" class="form-control @error('job') is-invalid @enderror" name="job" value="{{ old('job') }}" required autocomplete="job" placeholder="Votre proffession">
								...
								<div class="col-lg-12">
									...
									<div class="quote_btn text_center">
										<button class="btn" type="submit">Envoyer votre temoignage</button>
									</div>
								</div>
							</div>
						</form>
					...
					<div class="single_blog mb-4">
						...
						<div class="single_blog_content pl-4 pr-4">
							<div class="techno_blog_meta">
								<a href="#">Techno </a>
								<span class="meta-date pl-3">January 3, 2022</span>
							</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single_blog mb-4">
						...
						<div class="single_blog_content pl-4 pr-4">
							<div class="techno_blog_meta">
								<a href="#">Techno </a>
								<span class="meta-date pl-3">December 3, 2022</span>
							</div>
							<div class="blog_page_title pb-1">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single_blog mb-4">
						...
						<div class="single_blog_content pl-4 pr-4">
							<div class="techno_blog_meta">
								<a href="#">Techno </a>
								<span class="meta-date pl-3">Augost 5, 2022</span>
							</div>
							<div class="blog_page_title pb-1">
								<h3><a href="blog-details.html">The five devices you need to work anytime</a></h3>
							</div>
